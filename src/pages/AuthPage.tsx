...
const AuthPage = () => {
  ...
  const { signIn, signUp, user, loading, backendError } = useAuth();
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="glass-card rounded-3xl p-8">
          ...
          {/* Google Sign In */}
          {backendError && isInIframe ? (
            <a
              href="https://nextenbd.lovable.app/auth"
              target="_blank"
            ...
            >
              ...
              Continue with Google (opens published site)
            </a>
          ) : (
            <button
              type="button"
              onClick={async () => {
                try {
                  ...
                  toast({
                    ...
                    description: "Please try on the published site.",
                    variant: "destructive",
                  });
                }
              }}
